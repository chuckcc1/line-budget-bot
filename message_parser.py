...
- 帳單：信用卡費、卡費、還款、繳費帳單、電話帳單、水電帳單（已分類住的除外）
- 其他：不屬於以上任何類別

【payment 規則】（擇一回傳）：
- 信用卡：明確提到用信用卡「購買/消費」，例如：刷卡、刷信用卡、visa、mastercard
  ⚠️ 注意：「繳卡費」「繳信用卡費」「還卡費」是【繳帳單】，付款方式應為「現金」或「轉帳」，不是信用卡
- 現金：提到現金、付現、cash，或沒有提到任何付款方式時的預設值
- 悠遊卡：提到悠遊卡、easycard
...
【收入 category 規則】（type 為 income 時，擇一回傳）：
- 薪資：薪水、薪資、月薪、工資、底薪
- 獎金：年終、季獎、績效獎金、分紅、bonus
- 投資：股票、基金、ETF、股息、配息、利息、投資獲利、資本利得
- 兼職：兼差、打工、副業、接案、freelance、外包、稿費
- 租金：房租收入、出租、租金
- 贈與：紅包、禮金、贈與、壓歲錢
- 退款：退稅、退費、退款、保險理賠、退稅
- 其他收入：不屬於以上任何類別
